            ...
            <div class="scrollbar-inner scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 653px;">
                ...
                <div class="navbar-inner"> 
                    <div class="collapse navbar-collapse" id="sidenav-collapse-main"> 
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/add-staff"role="button" aria-expanded="false" aria-controls="navbar-examples">
                                    <i class="ni ni-align-center text-orange"></i>
                                    <span class="nav-link-text">Add Staff</span>
                                </a>  
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/view-staff"role="button" aria-expanded="false" aria-controls="navbar-examples">
                        ...
                        <ul class="navbar-nav mb-md-3">
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/add-dept"role="button" aria-expanded="false" aria-controls="navbar-examples">
                                    <i class="ni ni-app text-primary"></i>
                                    <span class="nav-link-text">Add Department</span>
                                </a>  
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/view-dept"role="button" aria-expanded="false" aria-controls="navbar-examples">
                    ...
                    <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold">Hello <strong>Admin</strong></span>
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.logout') }}" style="color: #333;"
