...
<div class="container">
    <div class="d-flex" style="justify-content: space-between; align-items: center;">
        ...
        <div>
            ...
            <a href="/admin/staffActivity/{{ $staffId }}/guestLecture/create" class="btn btn-primary" data-toggle="tooltip" data-original-title="Add Association" >
                ...
                @foreach($lectures as $key=>$mtg)
                    <tr>
                        ...
                        <td class="d-flex jes-sp" >
                            <a href="/admin/staffActivity/{{$staffId}}/guestLecture/{{ $mtg->id}}" data-toggle="tooltip" data-original-title="Edit Guest Lecture" >
                                <span class="btn-inner--icon"><i class="ti-pencil"></i></span> 
                            </a>
                            <a href="/admin/staffActivity/{{$staffId}}/guestLecture/delete/{{ $mtg->id}}" data-toggle="tooltip" data-original-title="Delete Guest Lecture" >
